...
export function genImagePrompts(C) {
    return [
        { id: 1, v: 'Clean dark background, bold white text overlay, brand accent stripe' },
        { id: 2, v: 'Split screen: left side shows old way, right side shows automated results dashboard' },
        { id: 3, v: 'Minimalist design with a single compelling stat centered, brand colors' },
        { id: 4, v: 'Dark gradient background with urgency-style countdown or limited spots indicator' },
        { id: 5, v: 'Futuristic visual with data streams, dark background, brand color glow' },
        { id: 6, v: 'Bold question format. Before/after comparison styled as an app interface.' },
        { id: 7, v: 'Full-screen stat with animated counter effect, dark bg, brand color text' },
        { id: 8, v: 'Screenshot-style mockup of results dashboard, clean and premium' },
        { id: 9, v: 'Dark bg with one key visual/stat representing speed. Brand blue accents. Clean typography.' },
        { id: 10, v: 'Story arc format: split image of problem vs agile solution. Dark gradients.' },
        { id: 11, v: 'Clean stat graphic with rising trend line, deep space blue background.' },
        { id: 12, v: 'Simple comparison infographic (old way vs new way) with sleek UI elements.' },
        { id: 13, v: 'Hero image: split-screen comparison of old way vs new way. 16:9 ratio. Dark, premium.' },
        { id: 14, v: 'Macro shot of someone looking relaxed while a glowing dashboard shows rising metrics.' },
        { id: 15, v: 'Minimal workspace, glowing laptop screen displaying exponential growth chart, dark aesthetic.' }
    ];
}
...
export function generateAll(C) {
    ...
    const imagePrompts = genImagePrompts(C);
    const combos = genCombos(hooks, heads, prims, ctas, C, 100);
    return { hooks, heads, prims, ctas, imagePrompts, combos };
}
