...
export function ProjectProvider({ children }) {
    ...
    useEffect(() => {
        setGeminiKey(localStorage.getItem('cos_gemini_key') || '');
    }, []);
    ...
    return (
        <ProjectContext.Provider value={{
            project, generated, generate, saveProject, loadProject, getProjects, factoryReset, DEFAULT_PROJECT, geminiKey, saveGeminiKey
        }}>
            {children}
