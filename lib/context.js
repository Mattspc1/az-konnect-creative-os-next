...
export function ProjectProvider({ children }) {
    ...
    const saveProject = useCallback(() => {
        ...
        projects.unshift({
            id: Date.now(), company: project.company, name: project.company,
            product: project.product, mode: project.mode,
            date: new Date().toLocaleDateString(), status: 'draft', client: { ...project }
        });
